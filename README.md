...
This project is a solution to technical test by Agile Content.

This project will be public until 2022-09-30. Until then, you can clone it using:

	https://github.com/HiannPatrick/CandidateTesting.PatrickHiannKonasugawa.git

This solution was made using this technologies:
	- .Net 6;
	- C#;

So, for you run this project, you need .Net 6. If you don't have .Net6, you can download it from:
		
	https://dotnet.microsoft.com/en-us/download/dotnet/6.0

Below is the the problem this solution resolved.
